...
There is a discernable shape in this plot of the linear variety. Therefore,  the linear model does not adequately describe the relationship between gift aid and family income.
...
The constant variance assumption is not satisfied because the residuals scatterplot does not have a slope equal to 0. Because the  slope is positive, there is a fan pattern.
